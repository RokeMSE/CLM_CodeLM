		...
		<div className={cn("flex flex-col gap-6", className)} {...props}>
			<Card className="bg-black text-white">
				<CardHeader>
					...
					<CardDescription>
						Forgot your password? No sweat! Enter your email and we
									...
									<div
										...
										onMouseEnter={() => {
											if (sendOTPIconRef.current) {
												sendOTPIconRef.current.classList.add(
													"animate-spin"
												);
											}
										}}
										onMouseLeave={() => {
											if (sendOTPIconRef.current) {
												sendOTPIconRef.current.classList.remove(
													"animate-spin"
												);
											}
										}}
